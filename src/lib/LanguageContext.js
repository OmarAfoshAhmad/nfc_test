...
export const translations = {
    ar: {
        ...
        confirm_add_package: 'هل توافق على إضافة الباقة؟',
        cancel_btn: 'إلغاء',
        ...
        auto_membership_discount: 'الخصم التلقائي للعضوية',
        auto_membership_discount_desc: 'تطبيق خصم العائلة/الأفراد تلقائياً أثناء الدفع عند عدم وجود خصم آخر',
        ...
        type_single: 'أفراد (خصم 12%)',
        type_family: 'عائلات (خصم 25%)',
        type_single_short: 'أفراد (12%)',
        type_family_short: 'عائلات (25%)',
        ...
        // NFC Security Management Additions
        system_status: 'حالة النظام',
        active_reader: 'القارئ النشط',
        monitor_terminal: 'تتبع جهاز محدد (عن بعد)',
        reader_disconnected_short: 'لا يوجد قارئ نشط',
        bridge_remote_note: 'تأكد من تشغيل الجسر المحلي أو اختيار جهاز "أونلاين" من القائمة أعلاه.',
        security_center: 'مركز الأمان',
        security_desc: 'أدوات تشفير وتأمين البطاقات المادية لضمان عدم التلاعب برصيد المشتركين.',
        place_card: 'يرجى وضع البطاقة على القارئ',
        waiting_for_scan: 'في انتظار عملية المسح...',
        detected_card: 'تم اكتشاف بطاقة',
        secured_card: 'بطاقة مؤمنة',
        unsecured_card: 'بطاقة غير مهيئة',
        unlinked_card: 'بطاقة غير مرتبطة',
        scan_source: 'مصدر المسح',
        injecting: 'جاري الحقن الأمني...',
        start_injection: 'بدء الحقن الأمني',
        revoke_security: 'إبطال التوقيع الأمني',
        dismiss: 'إغلاق',
        injection_process_desc: 'جاري إرسال مفاتيح التشفير للبطاقة المتصلة بالقارئ. يرجى عدم تحريك البطاقة حتى انتهاء العملية.',
        injection_success: 'تم الحقن بنجاح',
        card_secured_desc: 'البطاقة الآن تحمل توقيعاً رقمياً فريداً ولا يمكن التلاعب برصيدها.',
        uid: 'المعرف',
        status: 'الحالة',
        secured: 'مؤمنة',
        done: 'تم',
    ...
    en: {
        ...
        confirm_add_package: 'Do you agree to add this package?',
        cancel_btn: 'Cancel',
        ...
        auto_membership_discount: 'Auto Membership Discount',
        auto_membership_discount_desc: 'Automatically apply family/single membership discount during payment when no other discount is selected',
        ...
        type_single: 'Individuals (12% Off)',
        type_family: 'Families (25% Off)',
        type_single_short: 'Individuals (12%)',
        type_family_short: 'Families (25%)',
        ...
        monitor_terminal: 'Monitor Terminal (Remote)',
        reader_disconnected_short: 'No Active Reader',
        bridge_remote_note: 'Ensure local bridge is running or select an "Online" device above.',
        security_center: 'Security Center',
        security_desc: 'Encryption tools to secure physical cards and prevent balance tampering.',
        place_card: 'Please place card on reader',
        waiting_for_scan: 'Waiting for scan...',
        detected_card: 'Card Detected',
        secured_card: 'Secured Card',
        unsecured_card: 'Unsecured Card',
        unlinked_card: 'Unlinked Card',
        scan_source: 'Scan Source',
        injecting: 'Security injection in progress...',
        start_injection: 'Start Security Injection',
        revoke_security: 'Revoke Security Signature',
        dismiss: 'Dismiss',
        injection_process_desc: 'Sending encryption keys to the card. Please do not move the card.',
        injection_success: 'Injection Successful',
        card_secured_desc: 'The card now carries a unique digital signature and its balance cannot be tampered with.',
        uid: 'UID',
        status: 'Status',
        secured: 'Secured',
        done: 'Done',
